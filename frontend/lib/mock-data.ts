...
export const bgProjects: BGProject[] = [
  {
    id: "bg-proj-001",
    tenantId: "bbu-global-infra",
    clientId: "2",
    clientName: "BBU Global Infra Pvt Ltd",
  ...
  },
  {
    ...
    clientId: "2",
    clientName: "BBU Global Infra Pvt Ltd",
    name: "Greenfield Industrial Park – Phase 1",
    location: "IMT Manesar, Haryana",
    status: "active",
    startDate: "2026-01-10",
    endDate: "2026-12-31",
    totalBudget: 85000000,
    spentToDate: 22100000,
    completionPct: 26,
    activeOrders: 7,
    boqCount: 32,
  ...
  },
  {
    ...
    clientId: "2",
    clientName: "BBU Global Infra Pvt Ltd",
    name: "Metro Rail Junction Upgrade",
    location: "Dwarka, New Delhi",
    status: "planning",
    startDate: "2026-06-01",
    endDate: "2027-03-31",
    totalBudget: 121000000,
    spentToDate: 0,
    completionPct: 0,
    activeOrders: 0,
    boqCount: 0,
...
export const bgBOQItems: BGBOQItem[] = [
  {
    id: "bg-boq-001",
    projectId: "bg-proj-001",
  ...
  },
  {
    id: "bg-boq-002",
    projectId: "bg-proj-001",
    itemName: "Structural Steel Fabrication",
    unit: "MT",
    quantity: 200,
    unitCost: 120000,
    totalCost: 24000000,
  ...
  },
  {
    id: "bg-boq-003",
    projectId: "bg-proj-001",
    itemName: "Electrical Wiring & Conduits",
    unit: "m",
    quantity: 5000,
    unitCost: 450,
    totalCost: 2250000,
  ...
  },
  {
    id: "bg-boq-004",
    projectId: "bg-proj-001",
    itemName: "HVAC System Installation",
    unit: "unit",
    quantity: 1,
    unitCost: 3800000,
    totalCost: 3800000,
  ...
  },
  {
    id: "bg-boq-005",
    projectId: "bg-proj-001",
    itemName: "Interior Finishing & Gypsum",
    unit: "sqft",
    quantity: 8000,
    unitCost: 375,
    totalCost: 3000000,
  ...
  {
    id: "bg-boq-006",
    projectId: "bg-proj-002",
    itemName: "RCC Frame Construction",
    unit: "m³",
    quantity: 1200,
    unitCost: 16500,
    totalCost: 19800000,
  ...
  },
  {
    id: "bg-boq-007",
    projectId: "bg-proj-002",
    itemName: "Pre-Engineered Building Structure",
    unit: "MT",
    quantity: 480,
    unitCost: 115000,
    totalCost: 55200000,
...
export const bgVendors: BGVendor[] = [
  {
    id: "bg-ven-001",
    tenantId: "bbu-global-infra",
    name: "Premier Concrete Solutions",
    contact: "Rajesh Sharma",
    email: "ops@premierconcrete.in",
    category: "Civil",
    rating: 4.7,
  },
  {
    id: "bg-ven-002",
    tenantId: "bbu-global-infra",
    name: "Metro Steel Fabricators",
    contact: "Vikram Singh",
    email: "orders@metrosteel.in",
    category: "Structural",
    rating: 4.5,
  },
  {
  ...
  },
  {
    id: "bg-ven-004",
    tenantId: "bbu-global-infra",
    name: "HVAC Masters Ltd",
    contact: "Deepak Malhotra",
    email: "projects@hvacmasters.in",
    category: "MEP",
    rating: 4.6,
  },
  {
    id: "bg-ven-005",
    tenantId: "bbu-global-infra",
    name: "Apex Interior Works",
    contact: "Sunita Rathi",
    email: "bd@apexinterior.in",
    category: "Finishing",
    rating: 4.2,
  },
];

export const bgPurchaseOrders: BGPurchaseOrder[] = [
  {
    id: "bg-po-001",
    projectId: "bg-proj-001",
    projectName: "Riverside Commercial Tower",
    vendorId: "bg-ven-001",
    vendorName: "Premier Concrete Solutions",
    amount: 8750000,
    status: "approved",
    description: "Foundation concrete supply – Phase 1 (500 m³)",
  ...
  },
  {
    ...
    amount: 24000000,
    status: "sent",
    description: "Structural steel – 200 MT supply and erection",
  ...
  },
  {
    ...
    projectName: "Riverside Commercial Tower",
    vendorId: "bg-ven-003",
    vendorName: "ElectroPro Systems",
    amount: 1125000,
    status: "draft",
    description: "Electrical conduit and wiring – floors 1–5",
  ...
  },
  {
    ...
    projectName: "Riverside Commercial Tower",
    vendorId: "bg-ven-004",
    vendorName: "HVAC Masters Ltd",
    amount: 3800000,
    status: "approved",
    description: "Full HVAC system – design, supply, and installation",
    createdAt: "2026-03-12T14:00:00Z",
  },
  {
    id: "bg-po-005",
    projectId: "bg-proj-002",
    projectName: "Greenfield Industrial Park – Phase 1",
    vendorId: "bg-ven-001",
    vendorName: "Premier Concrete Solutions",
    amount: 19800000,
    status: "fulfilled",
    description: "RCC frame concrete supply – 1200 m³",
  ...
  },
  {
    ...
    amount: 55200000,
    status: "approved",
    description: "Pre-engineered building structure – 480 MT",
